...
import hashim.gallerylib.dragSelectRecyclerview.Mode.PATH
import hashim.gallerylib.dragSelectRecyclerview.Mode.RANGE
...
class DragSelectTouchListener private constructor(
  ...
  var hotspotHeight: Int = context.dimen(R.dimen.padding_56)
