 ...
 */
package hashim.gallerylib.dragSelectRecyclerview.attached
...
import hashim.gallerylib.dragSelectRecyclerview.CabAnimator
import hashim.gallerylib.dragSelectRecyclerview.CreateCallback
import hashim.gallerylib.dragSelectRecyclerview.DestroyCallback
import hashim.gallerylib.dragSelectRecyclerview.SelectCallback
import hashim.gallerylib.dragSelectRecyclerview.internal.color
import hashim.gallerylib.dragSelectRecyclerview.internal.colorAttr
import hashim.gallerylib.dragSelectRecyclerview.internal.drawable
import hashim.gallerylib.dragSelectRecyclerview.internal.onAnimationEnd
import hashim.gallerylib.dragSelectRecyclerview.internal.onLayout
import hashim.gallerylib.dragSelectRecyclerview.internal.removeSelf
import hashim.gallerylib.dragSelectRecyclerview.internal.requireOneColor
import hashim.gallerylib.dragSelectRecyclerview.internal.requireOneDimen
import hashim.gallerylib.dragSelectRecyclerview.internal.requireOneString
import hashim.gallerylib.dragSelectRecyclerview.internal.tint
import hashim.gallerylib.dragSelectRecyclerview.invokeAll
...
class RealAttachedCab internal constructor(
    ...
    init {
        ...
        backgroundColor(literal = attachedContext.color(R.color.colorPrimaryDark))
    }

    private var isDestroying: Boolean = false
    private val attachedContext: Activity
        get() = context
            ?: throw IllegalStateException("Contextual action bar is already destroyed.")
    ...
    fun startDestroy(): Boolean = synchronized(destroyLock) {
